...
private:
  inline void cb_playback_alpha_i(Fl_Value_Slider*, void*);
  static void cb_playback_alpha(Fl_Value_Slider*, void*);
public:
...
private:
  inline void cb_playback_fullscreen_i(Fl_Check_Button*, void*);
  static void cb_playback_fullscreen(Fl_Check_Button*, void*);
public:
