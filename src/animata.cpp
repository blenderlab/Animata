...
Vector2D AnimataWindow::transformMouseToWorld(int x, int y)
{
    ...
    // as all planes are parallel to the screen
    ...
    switch (ui->settings.mode) {
        ...
        case ANIMATA_MODE_CREATE_TRIANGLE:
            if (pointedPrevPrevVertex && pointedPrevVertex && pointedVertex) {
                cMesh->addFace(pointedPrevPrevVertex, pointedPrevVertex,
                               pointedVertex);
 ...
 **/
void AnimataWindow::setJointPrefsFromUI(enum ANIMATA_PREFERENCES prefParam,
                                        void *value)
{
 ...
 **/
void AnimataWindow::setBonePrefsFromUI(const char *name, float stiffness,
                                       float lengthMult)
{
 ...
 **/
void AnimataWindow::setAttachPrefsFromUI(float area, float falloff)
{
 ...
 * \param value parameter value cast to (void *)
 **/
void AnimataWindow::setLayerPrefsFromUI(enum ANIMATA_PREFERENCES prefParam,
                                        void *value)
{
